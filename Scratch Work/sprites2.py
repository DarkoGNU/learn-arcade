...
class Coin(arcade.Sprite):
    ...
    def reset_pos(self):
        ...
        self.top = random.randrange(SCREEN_HEIGHT + 20, SCREEN_HEIGHT + 600)
...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        # different groups. Other game engined might call these "sprite layers"
        # or "sprite groups". Sprites that don't move should be draw in their

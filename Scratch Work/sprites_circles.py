...
class MyGame(arcade.Window):
    ...
    def on_key_press(self, key, modifiers):
        ...
        if key == arcade.key.NUM_8 or key == arcade.key.NUM_UP:
            self.player_sprite.center_y += 10
        elif key == arcade.key.NUM_2 or key == arcade.key.NUM_DOWN:
            self.player_sprite.center_y -= 10
        elif key == arcade.key.NUM_4 or key == arcade.key.NUM_LEFT:
            self.player_sprite.center_x -= 10
        elif key == arcade.key.NUM_6 or key == arcade.key.NUM_RIGHT:
            self.player_sprite.center_x += 10
    ...
    def update(self, delta_time):
        ...
        if self.player_sprite.angle > 359:
